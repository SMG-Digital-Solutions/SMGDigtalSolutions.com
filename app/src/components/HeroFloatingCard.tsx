...
/**
 * Floating stat card shown alongside the hero headline. Wrapped in
 * `MotionConfig reducedMotion="user"` so the infinite float animation is
 * automatically disabled for visitors who have requested reduced motion at
 * the OS level (WCAG 2.3.3).
 */
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-bold text-[#121212] dark:text-white">AI-Powered Architecture</h3>
