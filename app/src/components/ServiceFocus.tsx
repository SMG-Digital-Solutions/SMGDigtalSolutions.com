              ...
              {category.services.map((service) => {
                ...
                return (
                  <motion.article key={service.title} variants={itemVariants} className="p-1">
                    ...
                    <p className="mt-2 text-sm leading-7 text-[#4b5563] dark:text-[#d5dde4]">{service.description}</p>
                  </motion.article>
                );
              })}
            </motion.div>
              ...
              {category.services.map((service) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-1.5 text-xs leading-5 text-[#4b5563] dark:text-[#d5dde4]">{service.description}</p>
                  </div>
                );
              })}
            </div>
